...
const LabResultsPatient = () => {
  ...
  async function getElements() {
    ...
    fetch(`${HTTP_CLIENT_URL}/contracts/getFilesbyPatientandType`, {
      ...
      body: JSON.stringify({ patientid,fileType: "LabResult" }),
    }).then(async res => {
  ...
  //if patient wants to see the file go to input private key of patient
  const press = (element) => {
    navigation.navigate("InputKey", { path: 'LabResultInfo', hash: element })
  }
