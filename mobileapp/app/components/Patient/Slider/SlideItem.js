...
const FileSlide = (item) => {
  ...
  const type = item.item.hash.fileType
  ...
  return (
    <View style={styles.container}>
      ...
      {
        type == "Temperature" && <View style={{ marginTop: 20 }}>
          ...
          <View style={styles.rowline}>
            <TouchableOpacity
              onPress={() => navigation.navigate('DataTemperature', { date: date.toLocaleDateString(), element: myData })}
            >
              <Text
                style={styles.linktext}
              >
