...
const { addDoctor, addPatient, signinDoctor, signinPatient, uploadFile, getAllFilesByPatientandType, getAllFilesByPatient, getFileType, getAllPermissionedFilesByPatient, getAllPermissionedFilesByDoctor, grantPermission, revokePermission } = require('../controllers/contracts')
